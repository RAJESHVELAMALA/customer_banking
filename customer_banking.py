...
def main():
    ...
    print(f"The updated savings account balance with interest earned is: {updated_savings_balance}")
    ...
    print(f"The updated CD account balance with interest earned is: {updated_cd_balance}")
